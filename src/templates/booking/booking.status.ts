const BOOKING_SHIPPING_STATUS_TO_CUSTOMER = `
      ...
      <tr>
        <td class="content">
          ...
          <table class="info-table">
            ...
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">New Status</td>
              <td class="info-td info-value" style="border-bottom: none; color: #0f172a; font-weight: 800; text-transform: capitalize">{{STATUS}}</td>
            </tr>
          </table>
          <p>Please log in to your dashboard to see the full history and current location of your shipment.</p>
          <table width="100%">
            <tr>
...
export default BOOKING_SHIPPING_STATUS_TO_CUSTOMER;
