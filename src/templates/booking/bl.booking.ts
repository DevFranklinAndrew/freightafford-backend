const BILL_OF_LADING_SENT_BY_ADMIN = `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Bill of Lading Uploaded</title>
  <style type="text/css">
...
<body>
  ...
  <tr>
    <td class="header">
      ...
      <tr>
        <td class="content">
          <h2>Bill of Lading Document Ready</h2>
          <p style='text-transform:capitalize'>Hello {{USERNAME}},</p>
          <p>A new Bill of Lading document has been uploaded for your booking.</p>
          <table class="info-table">
            ...
            <tr>
              <td class="info-td info-label">BL Type</td>
              <td class="info-td info-value" style='text-transform: capitalize'>{{TYPE}} Bill of Lading</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">BL Status</td>
              <td class="info-td info-value" style="border-bottom: none; text-transform: capitalize">{{STATUS}} Available</td>
            </tr>
          </table>
          <p>You can view and download the document from the "Bill of Lading" section of your dashboard.</p>
          <table width="100%">
            <tr>
              <td class="button-container">
                <a href="https://freightafford.com/app/customer" class="button">View Documents</a>
              </td>
            </tr>
          </table>
        </td>
...
export default BILL_OF_LADING_SENT_BY_ADMIN;
