const BOOKING_SHIPPING_UPDATE_TO_CUSTOMER = `
    ...
    <td class="header">
      ...
      <tr>
        <td class="content">
          ...
          <p>The shipping details for your booking have been updated. Here is the latest information:</p>
          <table class="info-table">
            ...
            <tr>
              <td class="info-td info-label">Sailing Date</td>
              <td class="info-td info-value">{{SAILING_DATE}}</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Carrier Booking #</td>
              <td class="info-td info-value" style="border-bottom: none;">{{CARRIER_BOOKING_NO}}</td>
            </tr>
          </table>
          <p>You can track your shipment and view more details in your dashboard.</p>
          <table width="100%">
            <tr>
              <td class="button-container">
                <a href="https://freightafford.com/app/customer" class="button">Track Shipment</a>
              </td>
            </tr>
          </table>
        </td>
...
export default BOOKING_SHIPPING_UPDATE_TO_CUSTOMER;
