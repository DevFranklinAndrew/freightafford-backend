const VERIFY_PAYMENT_BY_ADMIN_TO_CUSTOMER = `
    ...
    <td class="header">
      ...
      <tr>
        <td class="content">
          ...
          <p>Your payment for invoice has been reviewed.</p>
          <table class="info-table">
            ...
            <tr>
              <td class="info-td info-label">Action</td>
              <td class="info-td info-value" style="color: {{COLOR}}; text-transform: capitalize">{{ACTION}}</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Invoice Status</td>
              <td class="info-td info-value" style="border-bottom: none; font-weight: 800; text-transform: capitalize">{{STATUS}}</td>
            </tr>
          </table>
          
          <p>You can view your payment history and current booking status in your dashboard.</p>
          <table width="100%">
            <tr>
...
export default VERIFY_PAYMENT_BY_ADMIN_TO_CUSTOMER;
