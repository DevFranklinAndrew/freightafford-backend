const SEND_PAYMENT_PROOF_TO_ADMIN = `
    ...
    <td class="header">
      ...
      <tr>
        <td class="content">
          ...
          <p>Hello Admin,</p>
          <p>A customer has submitted proof of payment for an invoice.</p>
          <table class="info-table">
            ...
            <tr>
              <td class="info-td info-label">Payment Ref</td>
              <td class="info-td info-value">{{PAY_REFERENCE}}</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Status</td>
              <td class="info-td info-value" style="border-bottom: none; color: #f59e0b; text-transform: capitalize">{{STATUS}}</td>
            </tr>
          </table>
          <p>Please review the submitted document in the admin panel to verify the payment.</p>
          <table width="100%">
            <tr>
              <td class="button-container">
                <a href="https://freightafford.com/app/admin" class="button">Verify Payment</a>
              </td>
            </tr>
          </table>
        </td>
...
export default SEND_PAYMENT_PROOF_TO_ADMIN;
