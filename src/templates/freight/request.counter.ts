const FREIGHTREQUEST_COUNTER_BY_ADMIN_TO_CUSTOMER_TEMPLATE = `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Freight Request Countered</title>
  <style type="text/css">
...
<body>
  ...
  <tr>
    <td class="header">
      ...
      <tr>
        <td class="content">
          <h2>Freight Request Countered</h2>
          <p style='text-transform:capitalize'>Hello {{USERNAME}},</p>
          <p>Your freight request has been reviewed, and we have a <strong>Counter Offer</strong> for you to consider.</p>
          <table class="info-table">
            <tr>
              <td class="info-td info-label">Status</td>
              <td class="info-td info-value" style="color: #f59e0b;">Countered</td>
            </tr>
            <tr>
              <td class="info-td info-label">Counter Price</td>
              <td class="info-td info-value" style="color: #0f172a;">{{COUNTER_PRICE}} USD</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Reason</td>
              <td class="info-td info-value" style="border-bottom: none;">{{REASON}}</td>
            </tr>
          </table>
          <p>Please respond to this counter offer in your dashboard to proceed with the booking.</p>
          <table width="100%">
            <tr>
              <td class="button-container">
                <a href="https://freightafford.com/app/customer" class="button">Review Counter Offer</a>
              </td>
            </tr>
          </table>
          <p>Please see more details in your dashboard for more information or contact the support team of <strong>Freight Afford</strong>.</p>
        </td>
      </tr>
...
export default FREIGHTREQUEST_COUNTER_BY_ADMIN_TO_CUSTOMER_TEMPLATE;
