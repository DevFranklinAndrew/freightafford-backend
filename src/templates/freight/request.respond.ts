const FREIGHTREQUEST_RESPOND_BY_CUSTOMER_TO_ADMIN_TEMPLATE = `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Customer Responded to Counter</title>
  <style type="text/css">
...
<body>
  ...
  <tr>
    <td class="header">
      ...
      <tr>
        <td class="content">
          <h2>Customer Response to Counter Offer</h2>
          <p>Hello Admin,</p>
          <p>A customer has responded to your counter offer for their freight request.</p>
          <table class="info-table">
            <tr>
              <td class="info-td info-label">Customer</td>
              <td class="info-td info-value" style='text-transform:capitalize'>{{FULLNAME}}</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Decision</td>
              <td class="info-td info-value" style="border-bottom: none; color: {{COLOR}}; text-transform:capitalize">{{DECISION}}</td>
            </tr>
          </table>
          <p>Please check the admin dashboard to finalize the booking or review the next steps.</p>
          <table width="100%">
            <tr>
...
export default FREIGHTREQUEST_RESPOND_BY_CUSTOMER_TO_ADMIN_TEMPLATE;
