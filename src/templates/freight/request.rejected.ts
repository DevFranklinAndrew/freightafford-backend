const FREIGHTREQUEST_REJECTED_BY_ADMIN_TO_CUSTOMER_TEMPLATE = `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Freight Request Rejected</title>
  <style type="text/css">
...
<body>
  ...
  <tr>
    <td class="header">
      ...
      <tr>
        <td class="content">
          <h2>Freight Request Update</h2>
          <p style='text-transform:capitalize'>Hello {{USERNAME}},</p>
          <p>We regret to inform you that your freight request has been <strong>Rejected</strong> at this time.</p>
          <table class="info-table">
            <tr>
              <td class="info-td info-label">Status</td>
              <td class="info-td info-value" style="color: #ef4444;">Rejected</td>
            </tr>
            <tr>
          ...
          <p>You can view more details or submit a new request through your dashboard.</p>
          <table width="100%">
            <tr>
              <td class="button-container">
                <a href="https://freightafford.com/app/customer" class="button">Go to Dashboard</a>
              </td>
            </tr>
          </table>
...
export default FREIGHTREQUEST_REJECTED_BY_ADMIN_TO_CUSTOMER_TEMPLATE;
