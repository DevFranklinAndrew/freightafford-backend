const FREIGHTREQUEST_ACCEPTED_BY_ADMIN_TO_CUSTOMER_TEMPLATE = `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Freight Request Accepted</title>
  <style type="text/css">
...
<body>
  ...
  <tr>
    <td class="header">
      ...
      <tr>
        <td class="content">
          <h2>Freight Request Accepted!</h2>
          <p style='text-transform:capitalize;'>Hello {{USERNAME}},</p>
          <p>Great news! Your freight request has been <strong>Accepted</strong>. We are ready to proceed with your shipment.</p>
          <table class="info-table">
            <tr>
              <td class="info-td info-label">Status</td>
              <td class="info-td info-value" style="color: #10b981;">Accepted</td>
            </tr>
            <tr>
              <td class="info-td info-label" style="border-bottom: none;">Booking Number</td>
              <td class="info-td info-value" style="border-bottom: none;">{{BOOKING_NUMBER}}</td>
            </tr>
          </table>
          <p>You can now view the full booking details and track your shipment through your dashboard.</p>
          <table width="100%">
            <tr>
